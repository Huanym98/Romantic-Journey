  ...
  <div :class="['app-shell', 'route-' + app.route]">
    <header class="top" v-if="app.route!=='register'">
      <div class="top-inner">
        ...
        <div class="top-carousel" :title="activeHero.lang">{{activeHero.text}}</div>
        <nav class="nav">
    ...
    <section v-if="app.route==='register'" class="auth auth-simple">
      <div class="card auth-panel">
        <h2 class="auth-carousel-title">{{activeHero.text}}</h2>
        <p class="hint auth-carousel-lang">{{activeHero.lang}}</p>
